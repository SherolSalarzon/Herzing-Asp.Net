...
// Sherol Salarzon
namespace Assignment3Project.Controllers
{
    [Authorize]
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> AddOrEdit([Bind("Name,Author,Price")] Book book)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AuthDbContext.Book'  is null.");
            }
            var book = await _context.Book.FindAsync(id);
            if (book != null)
            {
